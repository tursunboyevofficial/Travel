...
import TourModal from "../../Pages/Tours/TourModal/TourModal";
      ...
      <div className={s.container}>
        <div className={s.columns}>
          ...
          <div className={s.column}>
            <h3 className={`${s.logo} ${s.logo1}`}>
              Samanid<span>Travel</span>
            </h3>
            ...
            <p>
              <FaEnvelope /> {t("footer.email1")}
            </p>
            <p>
              <FaEnvelope /> {t("footer.email2")}
            </p>
            <p>
          ...
          <div className={s.column}>
            ...
            <ul>
              ...
              <li>
                <a href="/tours">{t("footer.quickLinks.tours")}</a>
              </li>
              <li>
          ...
          <div className={s.column}>
            ...
            <div className={s.social}>
              ...
              <a
                ...
                rel="noreferrer"
              >
                <FaTelegram /> {t("footer.followUs.facebook")}
              </a>
            </div>
          </div>
        </div>

        <div className={s.copy}>{t("footer.copyright")}</div>
      </div>
    </footer>
  );
}
