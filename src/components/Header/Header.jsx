        ...
        <header className={`${s.header} ${scrolled ? s.scrolled : ""}`}>
            <div className={s.container}>
                ...
                <nav className={s.nav}>
                    ...
                    <NavLink to="/tours" className={({ isActive }) => (isActive ? s.active : "")}>
                        {t('nav_tours')} 
                    </NavLink>
                ...
                <div className={s.right}>
                    ...
                    <div className={s.lang}>
                        <FiGlobe />
                        <select 
                            onChange={handleLangChange} // <-- Til almashtirish funksiyasini ulaymiz
                            value={i18n.language} // <-- Hozirgi tanlangan tilni belgilaymiz
                        >
                            {LANGUAGES.map((lang) => (
            ...
            {mobileOpen && (
                <div className={s.mobileMenu}>
                    ...
                    <NavLink to="/tours" onClick={() => setMobileOpen(false)}>{t('nav_tours')}</NavLink>
